      ...
      <Card className="p-6 shadow-md" id="opd-invoice">
        <div className="space-y-6">
          ...
          <div className="border-b border-gray-200 pb-4">
            <h2 className="text-xl font-bold text-center text-primary">OPD Registration Receipt</h2>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-right">
              <div className="inline-block border-2 border-primary px-4 py-2 rounded-md">
                <p className="font-bold text-lg text-primary">Token #{registration.tokenNumber}</p>
              </div>
              <div className="mt-2 space-y-1">
                <p>
          ...
          <div className="border-t border-gray-200 pt-4">
            ...
            <div className="mt-2 grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <p>
                  <span className="text-gray-500">Consultation Fee:</span> ₹{doctor?.consultationFee || "---"}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-4 text-center text-sm text-gray-500">
            ...
            <p>Bring this receipt and any previous medical records for your consultation.</p>
          </div>
          ...
          <div className="border-t border-gray-200 pt-4 flex justify-between items-center">
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-gray-500">Babalal Ji Hospital</p>
            </div>
          </div>
        </div>
      </Card>
